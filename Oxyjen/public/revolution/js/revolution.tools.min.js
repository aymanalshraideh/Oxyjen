            ...
            (E._updateRoot = H.render =
                function () {
                    ...
                    if (
                        (K.length && $(),
                        Y.render(
                            (j.time - Y._startTime) * Y._timeScale,
                            !1,
                            !1
                        ),
                        X.render(
                            (j.frame - X._startTime) * X._timeScale,
                            !1,
                            !1
                        ),
                        K.length && $(),
        ...
        function (a) {
            var b,
                ...
                d = function (b, c) {
                    (this.vars = c = c || {}),
                        c.squash &&
                            (this.squash = new a(c.squashID || b + "-squash")),
                        a.call(this, b),
                        (this.bounce = this),
                        this.update(c);
                };
    ...
    _gsScope._gsDefine(
        ...
        function (a) {
            var b = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
                ...
                k = function (a) {
                    var b =
                        this.lookup[(a * this.l) | 0] ||
                        this.lookup[this.l - 1];
                    return (
                        b.nx < a && (b = b.n), b.y + ((a - b.x) / b.cx) * b.cy
                    );
                },
                l = function (b, c, d) {
                    (this._calcEnd = !0),
            ...
            return (
                ...
                (m.setData = function (a, c) {
                    ...
                    if (
                        ...
                        n < u.length - 1 &&
                            (this.lookup[l - 1] = u[u.length - 2]);
                    }
                    return (
                        (this._calcEnd =
                            1 !== u[u.length - 1].y || 0 !== u[0].y),
                        this
                    );
                }),
                (m.getRatio = k),
                ...
                (l.getSVGData = function (b, c) {
                    ...
                    if (
                        ...
                        for (
                            ...
                            (h = (((q + f * g * o) * n) | 0) / n),
                                (i =
                                    (((r + b.getRatio(f * g) * -p) * n) | 0) /
                                    n),
                                (Math.abs((i - m) / (h - l) - e) > k ||
                                    f === j - 1) &&
                                    (d.push(l + "," + m),
                                    (e = (i - m) / (h - l))),
                                (l = h),
...
!(function (a) {
    ...
    var b = a.GreenSockGlobals || a,
        ...
        v = function (a) {
            return (
                ((a.charCodeAt(0) - o) << 10) + (a.charCodeAt(1) - q) + 65536
            );
        },
