                        ...
                        if (
                            ...
                            if (((l[d].src = g.src), "img" == g.type)) {
                                if (c.slidebgimage) {
                                    ...
                                    var f =
                                        r.getElementsByTagName("rs-sbg-wrap");
                                    f.length > 0 &&
        ...
        j = function (a, r, o) {
            if (i[r] !== t) {
                if (
                    ...
                    (i[r].pr_active_bg =
                        i[r].pr_active_slide.find("rs-sbg-wrap")),
                    ...
                    if (i[o].layers[s].hasOwnProperty(n)) {
                        ...
                        if (void 0 === c.dataset.initialised) {
                            ...
                            if (
                                ...
                                (g.img = h.find("img")),
                                (g.deepiframe =
                                    h[0].getElementsByTagName("iframe")),
        ...
        var r = function (e, i) {
                var a =
                        "vertical" === e.direction
                            ? e.mask.find(e.single).first().outerHeight(!0) +
                              e.space
                            : e.mask.find(e.single).first().outerWidth(!0) +
                              e.space,
                    r =
                        "vertical" === e.direction
                            ? e.mask.height()
