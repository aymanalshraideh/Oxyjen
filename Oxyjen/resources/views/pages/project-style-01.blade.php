...
<!-- Mirrored from themetechmount.com/html/altech/project-style-01.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Aug 2022 06:55:34 GMT -->
<head>
<meta charset="utf-8">
                                        ...
                                        <ul class="dropdown">
                                           <li><a href="#">Home</a>
                                            ...
                                            <li class="active"><a href="#">Project</a>
                                                <ul>
                                                    <li class="active"><a href="project-style-01.html">Project Style 1</a></li>
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-center">
                            <div class="page-title-heading">
                                <h1 class="title"> Gallery Style 1</h1>
                        ...
                        <div class="col-lg-12">
                            <div class="ttm-tabs text-center ttm-tab-style-classic style2">
                                <ul class="tabs mb-20"><!-- tabs -->
                                    ...
                                    <li class="tab"><a href="#"> Business </a></li>
                                    <li class="tab"><a href="#"> Campaign </a></li>
                                    <li class="tab"><a href="#"> Technology </a></li>
                                    <li class="tab"><a href="#"> Corporate </a></li>
                                    <li class="tab"><a href="#"> Workshop </a></li>
                                    <li class="tab"><a href="#"> Innovation </a></li>
                                </ul><!-- tabs end-->
