...
<!-- Mirrored from themetechmount.com/html/altech/home-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Aug 2022 06:55:24 GMT -->
<head>
<meta charset="utf-8">
...
<body class="ttm-one-page-site">
    ...
    <div class="page">
                                ...
                                <div class="d-xl-flex flex-xl-row align-items-xl-center justify-content-xl-between">
                                    ...
                                    <div id="site-navigation" class="site-navigation" data-sticky-height="70">
                                        ...
                                        <nav id="menu" class="menu">
                                            <ul class="dropdown">
                                                <li><a aria-current="page" href="#ttm-home">Home</a></li>
                                                <li><a aria-current="page" href="#about-us">About Us</a></li>
                                                <li><a aria-current="page" href="#services">Services</a></li>
                                                <li><a aria-current="page" href="#projects">Projects</a></li>
                                                <li><a aria-current="page" href="#blog">Blog</a></li>
                                                <li><a aria-current="page" href="#contact-us">Contact Us</a></li>
                                            </ul>
                                        </nav>
        ...
        <rs-module-wrap id="rev_slider_1_3_wrapper" data-source="gallery">
            <rs-module id="rev_slider_1_3" style="" data-version="6.0.1" class="rev_slider_1_1_height">
                <rs-slides>

                    <rs-slide data-key="rs-3" data-title="Slide" data-thumb="images/slides/slider-mainbg-007.jpg" data-anim="ei:d;eo:d;s:1000;r:0;t:fade;sl:0;">

                        <img src="images/slides/slider-mainbg-007.jpg" title="banner-three.jpg" width="1920" height="790" class="rev-slidebg" data-no-retina>
                        ...
                        <a
                            ...
                            class="rs-layer"
                            href="contact-01.html" target="_self" rel="nofollow"
                            data-type="text"
                            data-color="#1c2842"
                            data-rsp_ch="on"
                            ...
                            data-frame_1="e:Linear.easeNone;st:760;sp:500;sR:760;"
                        ...
                        <a
                            ...
                            class="rs-layer"
                            href="home-2.html" target="_self" rel="nofollow"
                            data-type="text"
                            data-rsp_ch="on"
                        ...
                        <rs-layer
                            ...
                            data-text="w:normal;s:20,20,12,7;l:0,0,15,9;"
                            data-dim="w:561px,561px,351px,216px;h:522px,522px,327px,201px;"
                            data-vbility="t,t,t,f"
                            data-frame_0="sX:0.9;sY:0.9;"
                            data-frame_1="e:Linear.easeNone;st:100;sp:400;sR:100;"
                            data-frame_999="o:0;st:w;sR:8500;"
                            style="z-index:8;font-family:Roboto;"
                        ><img src="images/slides/slider-img-005.png" width="561" height="522" data-no-retina alt="slider-img"> 
                        </rs-layer>
                        ...
                        <rs-layer
                            ...
                            style="z-index:11;background-color:#b6bfd5;font-family:Roboto;"
                        > 
                        </rs-layer>
                        ...
                        <rs-layer
                            ...
                            data-frame_999_chars="e:Power4.easeInOut;d:10;x:-105%;o:0;rZ:-90deg;"
                            data-frame_999_mask="u:t;"
                            style="z-index:10;background-color:#263045;font-family:Roboto;"
                        > 
                        </rs-layer>
                        ...
                        <rs-layer
                            ...
                            data-frame_999_chars="e:Power4.easeInOut;d:10;x:-105%;o:0;rZ:-90deg;"
                            data-frame_999_mask="u:t;"
                            style="z-index:9;background-color:#2d4a8a;font-family:Roboto;"
                        > 
                        </rs-layer>
                        ...
                        <rs-layer
                            ...
                            style="z-index:12;background-color:#2d4a8a;font-family:Roboto;"
                        > 
                        </rs-layer>
                    ...
                    <rs-slide data-key="rs-4" data-title="Slide" data-thumb="images/slides/slider-mainbg-007.jpg" data-anim="ei:d;eo:d;s:1000;r:0;t:fade;sl:0;">
                        ...
                        <a
                            ...
                            class="rs-layer"
                            href="index.html" target="_self" rel="nofollow"
                            data-type="text"
                            data-color="#1c2842"
                            data-rsp_ch="on"
                        ...
                        <rs-layer
                            ...
                            style="z-index:8;font-family:Roboto;"
                        ><img src="images/slides/slider-img-006.png" width="663" height="637" data-no-retina alt="slider-img"> 
                        </rs-layer>
        ...
        <div class="site-main">
            ...
            <section id="about-us" class="ttm-row zero-padding-section mt_90 res-991-mt-0 clearfix">
                <div class="container">
                    <div class="row no-gutters">
                        <div class="col-lg-5">
                            <!-- col-bg-img-five -->
                            <div class="col-bg-img-five ttm-bg ttm-col-bgimage-yes ttm-left-span">
                               <div class="ttm-col-wrapper-bg-layer ttm-bg-layer">
                                    <div class="ttm-bg-layer-inner"></div>
                                </div>
                            </div>
                            <!-- Responsive View image -->
                            <img src="images/bg-image/col-bgimage-5.jpg" class="ttm-equal-height-image" alt="col-bgimage-5">
                        </div>
                        <div class="col-lg-7">
                            <div class="ttm-bgcolor-white ttm-bg ttm-col-bgcolor-yes z-11 position-relative ttm-right-span">
                                <div class="ttm-col-wrapper-bg-layer ttm-bg-layer">
                                    <div class="ttm-bg-layer-inner"></div>
                                </div>
                                <div class="layer-content">
                                    <div class="mt-90 res-991-mt-0">
                                    ...
                                    <div class="spacing-2 pr-0">
                                        ...
                                        <!-- separator -->
                                        <div class="about-text-box fs-16 pb-15 res-991-pb-0">
                                            <span>Call to ask <a href="contact-02.html" class="fw-500"><u>any question</u></a></span>
                                            <strong class="fs-18">: 123-456-7890</strong> or <strong class="fs-18">456-789-1430</strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="services-slide owl-carousel" data-item="3" data-nav="false" data-dots="false" data-auto="true">
                        ...
                        <div class="featured-imagebox featured-imagebox-services style2">
                            <div class="featured-thumbnail"><!-- featured-thumbnail -->
                                ...
                                <div class="ttm-overlay-iconbox">
                                    <a href="it-consultancy.html"><i class="ti ti-plus"></i></a>
                                </div>
                            </div> 
                            <div class="featured-content box-shadow">
                                <div class="featured-title"><!-- featured-title -->
                                    <h5>
                                        <a href="it-consultancy.html">
                                            <span class="ttm-icon ttm-icon_element-fill ttm-icon_element-bgcolor-skincolor ttm-icon_element-size-md m-0">
                                ...
                                <div class="featured-desc"><!-- featured-title -->
                                    <p>Lorem ipsum dolor sit amet, consectetur adipis incididunt ut labore dolore magna believe the idea aliqua.</p>
                                </div>
                                <a class="ttm-btn ttm-btn-size-md ttm-btn-color-dark btn-inline ttm-icon-btn-right mt-10" href="it-consultancy.html">Read More <i class="ti ti-angle-double-right"></i></a>
                            </div>
                        </div>
                        <!-- featured-imagebox-services end-->
                        <!-- featured-imagebox-services -->
                        <div class="featured-imagebox featured-imagebox-services style2">
                            <div class="featured-thumbnail"><!-- featured-thumbnail -->
                                ...
                                <div class="ttm-box-view-overlay"></div>
                                <div class="ttm-overlay-iconbox">
                                    <a href="digital-services.html"><i class="ti ti-plus"></i></a>
                                </div>
                            </div> 
                            <div class="featured-content box-shadow">
                                <div class="featured-title"><!-- featured-title -->
                                    <h5><a href="digital-services.html">
                                        <span class="ttm-icon ttm-icon_element-fill ttm-icon_element-bgcolor-skincolor ttm-icon_element-size-md m-0">
                                ...
                                <a class="ttm-btn ttm-btn-size-md ttm-btn-color-dark btn-inline ttm-icon-btn-right mt-10" href="digital-services.html">Read More <i class="ti ti-angle-double-right"></i></a>
                            </div>
                        </div>
                        <!-- featured-imagebox-services end-->
                        <!-- featured-imagebox-services -->
                        <div class="featured-imagebox featured-imagebox-services style2">
                            <div class="featured-thumbnail"><!-- featured-thumbnail -->
                                ...
                                <div class="ttm-box-view-overlay"></div>
                                <div class="ttm-overlay-iconbox">
                                    <a href="advisory-services.html"><i class="ti ti-plus"></i></a>
                                </div>
                            </div> 
                            <div class="featured-content box-shadow">
                                <div class="featured-title"><!-- featured-title -->
                                    <h5><a href="advisory-services.html">
                                            <span class="ttm-icon ttm-icon_element-fill ttm-icon_element-bgcolor-skincolor ttm-icon_element-size-md m-0">
                                                <i class="flaticon flaticon-data"></i>
                                            </span>Advisory Services
                                        </a>
                                    </h5>
                                </div>
                                <div class="featured-desc"><!-- featured-title -->
                                ...
                                <a class="ttm-btn ttm-btn-size-md ttm-btn-color-dark btn-inline ttm-icon-btn-right mt-10" href="advisory-services.html">Read More <i class="ti ti-angle-double-right"></i></a>
                            </div>
                        </div>
                        <!-- featured-imagebox-services end-->
                        <!-- featured-imagebox-services -->
                        <div class="featured-imagebox featured-imagebox-services style2">
                            <div class="featured-thumbnail"><!-- featured-thumbnail -->
                                ...
                                <div class="ttm-box-view-overlay"></div>
                                <div class="ttm-overlay-iconbox">
                                    <a href="data-structuring.html"><i class="ti ti-plus"></i></a>
                                </div>
                            </div> 
                            <div class="featured-content box-shadow">
                                <div class="featured-title"><!-- featured-title -->
                                    <h5><a href="data-structuring.html">
                                            <span class="ttm-icon ttm-icon_element-fill ttm-icon_element-bgcolor-skincolor ttm-icon_element-size-md m-0">
                                                <i class="flaticon flaticon-computer-1"></i>
                                            </span>Data Structuring
                                        </a>
                                    </h5>
                                </div>
                                <div class="featured-desc"><!-- featured-title -->
                                ...
                                <a class="ttm-btn ttm-btn-size-md ttm-btn-color-dark btn-inline ttm-icon-btn-right mt-10" href="data-structuring.html">Read More <i class="ti ti-angle-double-right"></i></a>
                            </div>
                        </div>
                        <!-- featured-imagebox-services end-->
                        <!-- featured-imagebox-services -->
                        <div class="featured-imagebox featured-imagebox-services style2">
                            <div class="featured-thumbnail box-shadow"><!-- featured-thumbnail -->
                                ...
                                <div class="ttm-box-view-overlay"></div>
                                <div class="ttm-overlay-iconbox">
                                    <a href="experience-design.html"><i class="ti ti-plus"></i></a>
                                </div>
                            </div> 
                            <div class="featured-content box-shadow">
                                <div class="featured-title"><!-- featured-title -->
                                    <h5><a href="experience-design.html">
                                            <span class="ttm-icon ttm-icon_element-fill ttm-icon_element-bgcolor-skincolor ttm-icon_element-size-md m-0">
                                ...
                                <a class="ttm-btn ttm-btn-size-md ttm-btn-color-dark btn-inline ttm-icon-btn-right mt-10" href="experience-design.html">Read More <i class="ti ti-angle-double-right"></i></a>
                            </div>
                        </div>
                        <!-- featured-imagebox-services end -->
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row no-gutters">
                                <div class="col-lg-9">
                                    <div class="ttm-col-bgcolor-yes ttm-col-bgimage-yes ttm-bg col-bg-img-six ttm-left-span spacing-12 z-index-0">
                                        <div class="ttm-col-wrapper-bg-layer ttm-bg-layer">
                                        ...
                                        <div class="layer-content">
                                            ...
                                            <div class="section-title with-desc">
                                                <div class="title-header">
                                                    <h5>About Us</h5>
                                                    <h2 class="title">We deal with the aspect of professional <span>It Services</span></h2>
                                                </div>
                                            </div><!-- section title end -->
                                            <div class="testimonial-slide style3 owl-carousel" data-item="1" data-nav="false" data-dots="true" data-auto="true">
                                                <!-- testimonials -->
                                                <div class="testimonials">
                                                    ...
                                                    <div class="testimonial-content">
                                                        <blockquote class="testimonial-text">"Each meeting, our time was well spent and we quickly delved to the heart of matters. We learned some good discipline strategies and were even supplied with a small guide to successfully.”</blockquote>
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="col-bg-img-seven ttm-col-bgimage-yes ttm-col-bgcolor-yes ttm-bgcolor-skincolor ttm-bg ttm-right-span spacing-13">
                                        <div class="ttm-col-wrapper-bg-layer ttm-bg-layer">
                                            <div class="ttm-col-wrapper-bg-layer-inner"></div>
                                        </div>
                                        <div class="layer-content">
                                            <!-- ttm_single_image-wrapper -->
                                            <div class="ttm_single_image-wrapper ml_230 position-relative z-index-2 res-991-ml-0 text-center">
                                                <div class="d-inline-block pt-10 pl-10 pr-10 pb-10 ttm-bgcolor-white box-shadow">
                                                    <img class="img-fluid" src="images/single-img_01.jpg" alt="single_01">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <!-- fid-section -->
            <section class="ttm-row fid_2-section ttm-bgcolor-darkgrey ttm-bg ttm-bgimage-yes bg-img10 clearfix">
            ...
            <section class="ttm-row bottomzero-padding-section clearfix">
                <div class="container">
                    <div class="row no-gutters"><!-- row -->
                        <div class="col-lg-5">
                            <!-- ttm_single_image-wrapper -->
                            <div class="ttm_single_image-wrapper z-1 position-relative text-lg-left text-center">
                                <img class="img-fluid" src="images/single-img_02.png" alt="single_02">
                            </div><!-- ttm_single_image-wrapper end -->
                            <div class="ttm-bg ttm-col-bgcolor-yes ttm-left-span ttm-bgcolor-skincolor spacing-15">
                            <div class="ttm-col-wrapper-bg-layer ttm-bg-layer"></div>
                            <div class="layer-content"></div>
                        </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="position-relative z-1 spacing-2"><!-- spacing-2 -->
                                <!-- section title -->
                                <div class="section-title with-desc clearfix">
                                    <div class="title-header">
                                        <h5>About us</h5>
                                    ...
                                    <div class="title-desc">
                                        <p>The argument in favor of using filler text goes something like this: If you use real content in the design process, anytime you reach a review point you’ll end up reviewing.</p>
                                    </div>
                                </div><!-- section title end -->
                                <div class="pt-30">
                                    <!-- progress-bar -->
                                    <div class="ttm-progress-bar" data-percent="92%">
                                        ...
                                        <div class="progress-bar-percent" data-percentage="92">92%</div><!-- progress-bar-percent -->
                                    </div>
                                    <!-- progress-bar END -->
                                    <!-- progress-bar -->
            ...
            <!-- portfolio-section -->
            <section id="projects" class="ttm-row portfolio-section ttm-bgcolor-grey clearfix">
                <div class="container">
                    <div class="row"><!-- row -->
                        <div class="col-lg-12">
                            <!-- section-title -->
                ...
                <div class="container-fluid">
                    <div class="row portfolio-slide owl-carousel ttm-boxes-spacing-10px" data-item="5" data-nav="false" data-dots="true" data-auto="false">
            ...
            <!-- zero-padding-section -->
            <section class="ttm-row bottomzero-padding-section ttm-bgcolor-grey clearfix">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row no-gutters">
                                <div class="col-lg-6">
                                    <div class="ttm-bgcolor-white ttm-bg ttm-col-bgcolor-yes z-11 position-relative ttm-left-span spacing-14">
                                        <div class="ttm-col-wrapper-bg-layer ttm-bg-layer">
                                            <div class="ttm-bg-layer-inner"></div>
                                        </div>
                                        ...
                                        <div class="layer-content">
                                            ...
                                            <form id="ttm-contact-form" class="row ttm-contact-form clearfix" method="post" action="#">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        <input name="phone" type="text" placeholder="Phone Number*" required="required" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        <input name="address" type="text" placeholder="Email Address*" required="required" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        <input name="subject" type="text" placeholder="Subject" required="required" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        <textarea name="Massage" rows="5" placeholder="Write A Massage..." required="required" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="text-left">
                                ...
                                <div class="col-lg-6">
                                    <!-- col-bg-img-eight -->
                                    <div class="col-bg-img-eight ttm-bg ttm-col-bgimage-yes ttm-right-span res-991-ml_15">
                                       <div class="ttm-col-wrapper-bg-layer ttm-bg-layer">
                                            <div class="ttm-bg-layer-inner"></div>
                                        </div>
                                    </div>
                                    <!-- Responsive View image -->
                                    <img src="images/bg-image/col-bgimage-8.jpg" class="ttm-equal-height-image" alt="col-bgimage-5">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- blog-section -->
            <section id="blog" class="ttm-row blog-section ttm-bgcolor-grey clearfix">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <!-- section title -->
                            <div class="section-title text-center with-desc pb-20 clearfix">
                                <div class="title-header">
                                    <h5>Our Blog</h5>
            ...
            <!-- topzero-section -->
            <section class="ttm-row topzero-padding-section mt_100 clearfix">
                <div class="container">
                    <!-- row -->
                    <div class="row">
                        <!-- blog-slide -->
                        <div class="blog-slide owl-carousel owl-theme owl-loaded " data-item="3" data-nav="false" data-dots="false" data-auto="false">
                            ...
                            <div class="featured-imagebox featured-imagebox-blog">
                                ...
                                <div class="featured-content"><!-- featured-content -->
                                    ...
                                    <a class="ttm-btn ttm-btn-size-sm ttm-btn-color-skincolor btn-inline ttm-icon-btn-right mt-20" href="single-blog.html">Read More <i class="ti ti-angle-double-right"></i></a>
                                </div>
                            </div><!-- featured-imagebox-blog end -->
                            <!-- featured-imagebox-blog -->
                            <div class="featured-imagebox featured-imagebox-blog">
                    ...
                    <div class="row align-items-md-center">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 order-md-3">
                            <div class="text-sm-right">
                                <a class="ttm-btn ttm-btn-size-md ttm-btn-style-border ttm-icon-btn-left ttm-btn-color-white" href="mailto:Info@example.com"> Info@example.com <i class="fa fa-envelope-o"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                            <div class="widget widget_text clearfix">
                                ...
                                <ul class="widget-post ttm-recent-post-list">
                                    <li>
                                        <a href="single-blog.html"><img src="images/vector_page/post-001-654x490.jpg" alt="post-img"></a>
                                        <a href="single-blog.html">10 Most Common IT Mistakes Need to Avoid</a>
                                        <span class="post-date"><i class="fa fa-calendar"></i>May 01, 2019</span>
                                    </li>
                                    <li>
                                        <a href="single-blog.html"><img src="images/vector_page/post-002-654x490.jpg" alt="post-img"></a>
                                        <a href="single-blog.html">How Can I Manage IT Services in Business ?</a>
                                        <span class="post-date"><i class="fa fa-calendar"></i>May 03, 2019</span>
                                    </li>
                                    <li>
                                        <a href="single-blog.html"><img src="images/vector_page/post-003-654x490.jpg" alt="post-img"></a>
                                        <a href="single-blog.html">5 Easy Ways to Improve Your Web Security</a>
...
<!-- Mirrored from themetechmount.com/html/altech/home-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Aug 2022 06:55:27 GMT -->
</html>