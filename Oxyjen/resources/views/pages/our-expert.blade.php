...
<!-- Mirrored from themetechmount.com/html/altech/our-expert.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Aug 2022 06:55:30 GMT -->
<head>
<meta charset="utf-8">
                                           ...
                                           <li><a href="#">Home</a>
                                            ...
                                            <li class="active"><a href="#">Pages</a>
                                                <ul>
                                                    ...
                                                    <li class="active"><a href="our-expert.html">Our Expert</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-sm-6">
                            ...
                            <div class="featured-imagebox featured-imagebox-team style1 mb-30">
                                ...
                                <div class="featured-content box-shadow">
                                    <div class="featured-title"><!-- featured-title -->
                                        <h5><a href="team-details.html">Enna Mason</a></h5>
                                    </div>
                                    <p class="category">Product Analyst</p><!-- category -->
                                </div>
                            </div><!-- featured-imagebox-team end-->
                        </div>
                        <div class="col-md-6 col-lg-4 col-sm-6">
                            ...
                            <div class="featured-imagebox featured-imagebox-team style1 mb-30">
                                ...
                                <div class="featured-content box-shadow">
                                    <div class="featured-title"><!-- featured-title -->
                                        <h5><a href="team-details.html">John Bruce</a></h5>
                                    </div>
                                    <p class="category">IT Associative</p><!-- category -->
                                </div>
                            </div><!-- featured-imagebox-team end-->
                        </div>
                    </div>
