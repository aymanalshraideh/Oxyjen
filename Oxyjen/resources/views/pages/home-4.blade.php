...
<!-- Mirrored from themetechmount.com/html/altech/home-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Aug 2022 06:55:22 GMT -->
<head>
<meta charset="utf-8">
    ...
    <div class="page">
                                ...
                                <div id="site-navigation" class="site-navigation" data-sticky-height="70">
                                    ...
                                    <nav id="menu" class="menu">
                                        <ul class="dropdown">
                                            ...
                                            <li><a aria-current="page" href="#team">Team</a></li>
        ...
        <rs-module-wrap id="rev_slider_1_1_wrapper" data-source="gallery">
            <rs-module id="rev_slider_1_1" style="" data-version="6.0.1" class="rev_slider_1_1_height">
                <rs-slides>
                    <!-- rs-slide -->
                    <rs-slide data-key="rs-3" data-title="Slide" data-thumb="images/vector_page/vectorpage-banner-01.jpg" data-anim="ei:d;eo:d;s:1000;r:0;t:fade;sl:0;">

                        <img src="images/vector_page/vectorpage-banner-01.jpg" title="slider-mainbg-003" width="1920" height="790" class="rev-slidebg" data-no-retina>
                        ...
                        <rs-layer
                            ...
                            data-text="w:normal;s:18,15,15,10;l:25,20,15,9;fw:500;"
                        ...
                        <rs-layer
                            ...
                            data-dim="w:36px,29px,22px,13px;h:2px,1px,1px,1px;"
                        ...
                        <rs-layer
                            ...
                            data-text="w:normal;s:50,41,45,37;l:70,57,50,60;fw:600;"
                            data-frame_0="x:-50,-41,-31,-19;"
                        ...
                        <rs-layer
                            ...
                            data-text="w:normal;s:50,41,45,37;l:72,59,60,60;fw:600;"
                            data-frame_0="x:-50,-41,-31,-19;"
                        ...
                        <a
                            ...
                            data-padding="t:12,10,8,5;r:35,29,22,14;b:15,12,9,6;l:35,29,22,14;"
                            data-frame_0="y:50,41,31,19;"
                        ...
                        <rs-layer
                            ...
                            data-text="w:normal;s:20,16,12,7;l:0,20,15,9;"
                            data-dim="w:697px,575px,436px,268px;h:537px,443px,336px,207px;"
                            data-vbility="t,t,t,f"
                            data-frame_0="sX:0.9;sY:0.9;"
                            data-frame_1="e:Linear.easeNone;st:100;sp:400;sR:100;"
                            data-frame_999="o:0;st:w;sR:8500;"
                            style="z-index:8;font-family:Roboto;"
                        ><img src="images/vector_page/vectorpage-banner-single_img1.png" width="807" height="622" data-no-retina alt="banner-single_img1"> 
                        </rs-layer>
                        ...
                        >We are equipped with an updated technical knowledge to serve <br> customers properly. Our method of application industry. 
                        </rs-layer>
                    ...
                    <!-- rs-slide -->
                    <rs-slide data-key="rs-4" data-title="Slide" data-thumb="images/vector_page/vectorpage-banner-01.jpg" data-anim="ei:d;eo:d;s:1000;r:0;t:fade;sl:0;">

                        <img src="images/vector_page/vectorpage-banner-01.jpg" title="slider-mainbg-004" width="1920" height="790" class="rev-slidebg" data-no-retina>
                        ...
                        <rs-layer
                            ...
                            data-text="w:normal;s:20,16,12,7;l:0,20,15,9;"
                            data-dim="w:579px,478px,363px,223px;h:553px,456px,346px,213px;"
                            data-vbility="t,t,t,f"
                            data-frame_0="x:-50,-41,-31,-19;"
                            data-frame_1="st:100;sp:1000;"
                            data-frame_999="o:0;st:w;sR:8500;"
                            style="z-index:8;font-family:Roboto;"
                        ><img src="images/vector_page/vectorpage-banner-single_img2.png" width="598" height="571" alt="banner-single_img2" data-no-retina> 
                        </rs-layer>
        ...
        <div class="site-main">
            ...
            <section id="about" class="ttm-row topzero-padding-section vector_bg-img1 clearfix">
                <div class="container">
                    <div class="row"><!-- row -->
                        <div class="col-lg-6">
                            <div class="pt-30 res-991-pt-0">
                                <!-- section title -->
                                <div class="section-title with-desc clearfix">
                                    <div class="title-header">
                                        <h5>About Us</h5>
                                        <h2 class="title">We are here to fight against violance with <span> experience</span></h2>
                                    </div>
                                    <div class="title-desc">
                                        <p>The argument in favor of using filler text goes something like this: If you use real content in the design process.</p>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-6 col-sm-6">
                                        ...
                                        <div class="featured-icon-box style3 left-icon icon-align-top">
                                            ...
                                            <div class="featured-content"><!--  featured-content -->
                                                <div class="featured-title mb-5"><!--  featured-title -->
                                ...
                                <!-- separator -->
                                <div class="separator">
                                    <div class="sep-line mt-35 mb-30"></div>
                                </div>
                                <!-- separator -->
                                <!--  featured-icon-box --> 
                                <div class="featured-icon-box left-icon icon-align-top">
                                    <div class="featured-icon">
                                        <img src="images/about-sign-2.png" alt="about-sign">
                                    </div>
                                    <div class="featured-content"><!--  featured-content -->
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-10 col-10 m-auto">
                            ...
                            <div class="ttm_single_image-wrapper pt-30">
                                <img class="img-fluid" src="images/vector_page/single_01.jpg" alt="single-01">
                    ...
                    <div class="row pt-90 res-991-pt-50"><!-- row -->
                        <div class="col-lg-6 col-md-6 col-sm-10 col-10 m-auto">
                            <!-- ttm_single_image-wrapper -->
                            <div class="ttm_single_image-wrapper">
                                <img class="img-fluid" src="images/vector_page/single_02.png" alt="single-02">
                            </div><!-- ttm_single_image-wrapper end -->
                        </div>
                        <div class="col-lg-6">
                            <div class="pl-30 res-991-pl-0 res-991-mt-40">
                                ...
                                <div class="pt-30 ttm-textcolor-darkgrey">
                                    <!-- progress-bar -->
                                    ...
                                    <div class="ttm-progress-bar" data-percent="82%">
                                        <div class="progress-bar-title">Business Growth</div><!-- progress-bar-TITLE -->
                                        <div class="progress-bar-inner">
                                            <div class="progress-bar progress-bar-color-bar_skincolor"></div>
                                        </div>
                                        <div class="progress-bar-percent" data-percentage="82">82%</div><!-- progress-bar-PERCENT -->
                                    </div>
                                    <!-- progress-bar END -->
                                    <!-- progress-bar -->
                                    <div class="ttm-progress-bar" data-percent="90%">
                                        <div class="progress-bar-title">Technology Solution</div><!-- progress-bar-title -->
                                        <div class="progress-bar-inner">
                                            <div class="progress-bar progress-bar-color-bar_skincolor"></div>
                                        </div>
            ...
            <!-- topzero-padding-section end -->


            <!-- cta-section -->
            <section class="ttm-row cta-section vector_bg-img2 clearfix">
                <div class="container">
                    <div class="row align-items-md-center justify-content-between"><!-- row -->
                        <div class="col-lg-7 col-md-7 mr-auto">
                            <!-- section-title -->
                            <div class="section-title clearfix">
                                <div class="title-header">
                                    <h5>More Than 50,000 Happy Client</h5>
                                    <h2 class="title">We Provide Outsourced IT Services For Small & <span>Mid-Sized Business</span></h2>
                                </div>
                                <div class="title-desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard.</div>
                            </div><!-- section-title end -->
                            <div class="mt-40 res-991-mb-30">
                                <a href="#" class="ttm-btn ttm-btn-size-md ttm-btn-style-border ttm-btn-color-darkgrey">Get Altech</a>
                            </div>
                        </div>
                        <div class="col-lg-1 col-md-2">
                            <div class="ttm-play-icon-btn m-auto d-block text-center">
            ...
            <!-- services-section -->
            <section id="services" class="ttm-row services_2-section vector_bg-img3 clearfix">
                <div class="container">
                    <div class="row"><!-- row -->
                        <div class="col-lg-7 col-md-7 col-sm-10 m-auto">
                            ...
                            <div class="section-title with-desc text-center clearfix">
                                <div class="title-header">
                                    <h5>Our Services</h5>
                                    <h2 class="title">We are here to fight against any violance with <span> experience</span></h2>
                                </div>
                            </div><!-- section title end -->
                        </div>
                    </div>
                        ...
                        <div class="history-slide owl-carousel" data-item="3" data-nav="false" data-dots="false" data-auto="true">
                            ...
                            <div class="featured-icon-box style9">
                                <div class="featured-icon"><!--  featured-icon -->
                                    ...
                                    <div class="servicebox-number">01</div>
                                </div>
                                <div class="featured-content">
                                    <div class="featured-title"><h5>IT Consultancy</h5></div>
                                    <div class="featured-desc"> 
                                        Expertise in IT consultancy for the IT companies, for their different working areas Web-app related.
                                    </div>
                                    <a class="ttm-btn ttm-btn-size-sm ttm-btn-color-dark btn-inline ttm-icon-btn-right mt-20" href="#">Read More <i class="ti ti-angle-double-right"></i></a>
                                </div>
                            </div><!-- featured-icon-box END--> 
                            <!--  featured-icon-box --> 
                            <div class="featured-icon-box style9">
                                <div class="featured-icon"><!--  featured-icon -->
                                    ...
                                    <div class="servicebox-number">02</div>
                                </div>
                                <div class="featured-content">
                                    <div class="featured-title"><h5>IT Management</h5></div><!-- historybox-title  --> 
                                    <div class="featured-desc"><!-- description  --> 
                            ...
                            <div class="featured-icon-box style9">
                                <div class="featured-icon"><!--  featured-icon -->
                                    ...
                                    <div class="servicebox-number">03</div>
                                </div>
                                <div class="featured-content">
                                    <div class="featured-title"><h5>Product Design</h5></div><!-- historybox-title  --> 
                                    <div class="featured-desc"><!-- description  --> 
                            ...
                            <div class="featured-icon-box style9">
                                <div class="featured-icon"><!--  featured-icon -->
                                    ...
                                    <div class="servicebox-number">04</div>
                                </div>
                                <div class="featured-content">
                                    <div class="featured-title"><h5>Cloud Services</h5></div><!-- historybox-title  --> 
                                    <div class="featured-desc"><!-- description  --> 
                    ...
                    <div class="row pt-90"><!-- row -->
                        ...
                        <div class="col-lg-6">
                            <div class="pl-30 res-991-pl-0 res-991-mt-40">
                                ...
                                <div class="section-title with-desc clearfix">
                                    <div class="title-header">
                                        <h5>Recruitment Technologies</h5>
                                        <h2 class="title">Solving Recruitment Using <span> Technology</span></h2>
                                    </div>
                                    <div class="title-desc">
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words</p>
                                    </div>
            ...
            <!-- team-section -->
            <section id="team" class="ttm-row bottomzero-padding-section vector_bg-img4 mt_10 clearfix">
                <div class="container">
                    <div class="row"><!-- row -->
                    ...
                    <!-- row -->
                    <div class="row">
                        <div class="team-slide owl-carousel mt-10" data-item="3" data-nav="false" data-dots="false" data-auto="false">
                                            ...
                                            <div class="testimonial-slide style2 owl-carousel" data-item="1" data-nav="true" data-dots="false" data-auto="false">
                                                ...
                                                <div class="testimonials text-center style2"> 
                                                    <div class="testimonial-content"><!-- testimonials-content -->
                                                        <blockquote>Our team discussed every single detail to make sure Creatives Planet is the most versatile and unique theme created so far.No coding skills required loream ipsum simply dummy text contary.</blockquote>
            ...
            <!-- blog-section end -->
            <section id="blog" class="ttm-row blog-section clearfix">
                <div class="container">
                    <div class="row"><!-- row -->
                        <div class="col-lg-9 col-xl-10 col-md-9">
                            ...
                            <div class="section-title style2 clearfix">
                                <div class="title-header">
                                    <h5>Our Blog</h5>
                                    <h2 class="title">Check Out <span>Latest News</span></h2>
                                </div>
                                <div class="title-desc">The argument in favor of using filler text goes something like this: If you use real content in the design.</div>
                            </div><!-- section-title end -->
                        </div>
                        <div class="col-lg-3 col-xl-2 col-md-3">
                            <div class="text-md-right">
                                <a class="ttm-btn ttm-btn-size-md ttm-btn-style-fill ttm-btn-bgcolor-skincolor mb-40" href="#"> View More </a>
                            </div>
                        </div>
                    </div>
                    <!-- row -->
                    <div class="row">
                        ...
                        <div class="blog-slide owl-carousel owl-theme owl-loaded " data-item="3" data-nav="false" data-dots="false" data-auto="false">
                            ...
                            <div class="featured-imagebox featured-imagebox-blog style2">
                                <div class="featured-thumbnail"><!-- featured-thumbnail -->
                                    <img class="img-fluid" src="images/vector_page/post-001-654x490.jpg" alt="">
                                ...
                                <div class="featured-content"><!-- featured-content -->
                                    ...
                                    <div class="featured-title"><!-- featured-title -->
                                        <h5><a href="single-blog.html">10 Most Common IT Mistakes Need to Avoid</a></h5>
                                    </div>
                            ...
                            <div class="featured-imagebox featured-imagebox-blog style2">
                                <div class="featured-thumbnail"><!-- featured-thumbnail -->
                                    <img class="img-fluid" src="images/vector_page/post-002-654x490.jpg" alt="">
                                    <div class="ttm-blog-overlay-iconbox">
                                        <a href="single-blog.html"><i class="ti ti-plus"></i></a>
                                    </div>
                                    <div class="ttm-box-view-overlay"></div>
                                ...
                                <div class="featured-content"><!-- featured-content -->
                                    ...
                                    <div class="featured-title"><!-- featured-title -->
                                        <h5><a href="single-blog.html">How Can I Manage IT Services in Business ?</a></h5>
                                    </div>
                                    <div class="post-meta"><!-- post-meta -->
                                        <span class="ttm-meta-line"><i class="fa fa-comments"></i>0 comments</span>
                                        <span class="ttm-meta-line"><i class="fa fa-user"></i>Admin</span>
                            ...
                            <div class="featured-imagebox featured-imagebox-blog style2">
                                <div class="featured-thumbnail"><!-- featured-thumbnail -->
                                    <img class="img-fluid" src="images/vector_page/post-003-654x490.jpg" alt="">
                                    <div class="ttm-blog-overlay-iconbox">
                                        <a href="single-blog.html"><i class="ti ti-plus"></i></a>
                                    </div>
                                    <div class="ttm-box-view-overlay"></div>
                                ...
                                <div class="featured-content"><!-- featured-content -->
                                    ...
                                    <div class="featured-title"><!-- featured-title -->
                                        <h5><a href="single-blog.html">5 Easy Ways to Improve Your Web Security</a></h5>
                                    </div>
                                    <div class="post-meta"><!-- post-meta -->
                                        <span class="ttm-meta-line"><i class="fa fa-comments"></i>0 comments</span>
                                        <span class="ttm-meta-line"><i class="fa fa-user"></i>Admin</span>
...
<!-- Mirrored from themetechmount.com/html/altech/home-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Aug 2022 06:55:24 GMT -->
</html>