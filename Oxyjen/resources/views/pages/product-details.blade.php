...
<!-- Mirrored from themetechmount.com/html/altech/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Aug 2022 06:55:47 GMT -->
<head>
<meta charset="utf-8">
                                           ...
                                           <li><a href="#">Home</a>
                                            ...
                                            <li class="active"><a href="#">Shop</a>
                                                <ul>
                                                    ...
                                                    <li class="active"><a href="product-details.html">Single Product Details</a></li>
                            ...
                            <div class="ttm-single-product-info clearfix">
                                <div class="product-gallery images">
                                    <figure class="ttm-product-gallery__wrapper">
                                        ...
                                        <div class="product-gallery__image">
                                            <img class="img-fluid" src="images/product/product-three.jpg" alt="product-img">
                                        </div>
                                        <div class="product-gallery__image">
                                ...
                                <div class="summary entry-summary">
                                    <h3 class="singel_product_title">Beanie with Logo</h3>
                                    ...
                                    <div class="product_meta">
                                        <div  class="sku_wrapper">
                                            <span>SKU: </span>
                                            <a href="#" rel="tag">Woo-beanie-logo</a>
                                        </div>
                                        <div class="posted_in">
                                            <span>Category: </span>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea name="Massage" rows="3" placeholder="" required="required" class="form-control border-bottom"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Name*</label>
                                                                    <input name="name" type="text" class="form-control border-bottom" placeholder="" required="required">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label>Email*</label>
                                                                    <input name="email" type="text" placeholder="" required="required" class="form-control border-bottom">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
