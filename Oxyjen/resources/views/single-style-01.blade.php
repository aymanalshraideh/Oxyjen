...
<!-- Mirrored from themetechmount.com/html/altech/single-style-01.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Aug 2022 06:55:35 GMT -->
<head>
<meta charset="utf-8">
                                            ...
                                            <li class="active"><a href="#">Project</a>
                                                <ul>
                                                    ...
                                                    <li class="active"><a href="#">Project Single</a>
                                                        <ul>
                                                            <li class="active"><a href="single-style-01.html">Single Style 1</a></li>
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-center">
                            <div class="page-title-heading">
                                <h1 class="title"> Single Style 1</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xl-8">
                            ...
                            <div class="ttm_single_image-wrapper mb-35">
                                <img class="img-fluid" src="images/single-img-twenty.jpg" title="single-img-twenty" alt="single-img-twenty">
