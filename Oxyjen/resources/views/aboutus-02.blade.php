...
<!-- Mirrored from themetechmount.com/html/altech/aboutus-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Aug 2022 06:55:29 GMT -->
<head>
<meta charset="utf-8">
...
<body>
    ...
    <div class="page">
                                           ...
                                           <li><a href="#">Home</a>
                                            ...
                                            <li class="active"><a href="#">Pages</a>
                                                <ul>
                                                    ...
                                                    <li class="active"><a href="aboutus-02.html">About Us 2</a></li>
        ...
        <div class="site-main">
            ...
            <!-- aboutus-section -->
            <section class="ttm-row aboutus-section-style3 clearfix">
                <div class="container">
                    <div class="row"><!-- row -->
                        <div class="col-lg-6">
                            <div class="position-relative">
                                ...
                                <div class="ttm_single_image-wrapper text-sm-center mr-35 res-991-m-0">
                                    <img class="img-fluid" src="images/single-img-nine.jpg" title="single-img-nine" alt="single-img-nine">
                                ...
                                <div class="ttm-highlight-fid-style-2">
                                    ...
                                    <div class="ttm-fid inside without-icon">
                                        <div class="ttm-fid-contents">
                                            ...
                                            <h3 class="ttm-fid-title">Successully Projects </h3>
                                        </div>
                                    </div><!-- ttm-fid end-->
                                </div>
                            </div>
                            ...
                            <div class="res-991-mt-30">
                                ...
                                <div class="section-title with-desc clearfix">
                                    <div class="title-header">
                                        <h5>About us</h5>
                                        <h2 class="title">Product development for<br> better <span>Business</span></h2>
                                    </div>
                ...
                <div class="container">
                    <div class="row no-gutters">
                        <div class="col-lg-6">
                            ...
                            <img src="images/bg-image/col-bgimage-1.jpg" class="ttm-equal-height-image" alt="col-bgimage-1">
                        </div>
                        <div class="col-lg-6">
