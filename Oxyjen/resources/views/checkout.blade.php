...
<!-- Mirrored from themetechmount.com/html/altech/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Aug 2022 06:55:47 GMT -->
<head>
<meta charset="utf-8">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div id="order_review" class="checkout-review-order">
                                        <table class="shop_table checkout-review-order-table">
                                            ...
                                            <tbody>
                                                <tr class="cart_item">
                                                    <td class="product-name">Hoodie with Zipper&nbsp;
